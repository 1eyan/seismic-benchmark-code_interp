...
BASE_CONFIG="${REPO_ROOT}/configs/coherent_noise_attenuation/denoise_enhanced_unet.yaml"
PY_SCRIPT="${REPO_ROOT}/scripts/coherent_noise_attenuation/train_denoise_enhanced_unet.py"
