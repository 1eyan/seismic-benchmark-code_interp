...
CUDA_VISIBLE_DEVICES=6,7 torchrun --nproc_per_node=2 \\
    scripts/coherent_noise_attenuation/train_denoise_physics.py \\
    --config configs/coherent_noise_attenuation/denoise_physics.yaml
"""
...
from model.coherent_noise_attenuation.physics_unet import FKClassifier  # noqa: E402
