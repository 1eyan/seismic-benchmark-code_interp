...
CUDA_VISIBLE_DEVICES=6,7 torchrun --nproc_per_node=2 \\
    scripts/coherent_noise_attenuation/train_denoise_pix2pix.py \\
    --config configs/coherent_noise_attenuation/denoise_pix2pix.yaml
"""
...
from model.coherent_noise_attenuation.pix2pix import Pix2PixDiscriminator  # noqa: E402
