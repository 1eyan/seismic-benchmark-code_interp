...
BASE_CONFIG="${REPO_ROOT}/configs/coherent_noise_attenuation/denoise_sanet.yaml"
PY_SCRIPT="${REPO_ROOT}/scripts/coherent_noise_attenuation/train_denoise_sanet.py"
