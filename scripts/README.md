...
- `interpolation/` — Interpolation training (`train_interpolation_unet.py`, `train_paired_unet.py`, `train_interpolation_transformer.py`) and inference (`inference_interpolation.py`). Supports UNet, DnCNN, ResNet, DBiLSTM, BTN, MST, Gated Transformer, and ViT models.
