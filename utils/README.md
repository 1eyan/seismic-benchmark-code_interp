...
- `fb_fre_metrics.py` — Frequency-Binned Fidelity and Recovery Evaluation (BNE/BER/BCC per adaptive frequency band), useful for diagnosing frequency recovery quality.
